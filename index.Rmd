...
<div style="display: flex; align-items: flex-start; gap: 20px;">
  ...
  <!-- Quote Section -->
  <blockquote style="font-style: italic; color: #555; border-left: 4px solid #ccc; padding-left: 10px; margin: 0; background-color: #f9f9f9; flex: 1;">
    ...
    <br><strong>— r/birdwatching, Reddit</strong>
  </blockquote>

  <!-- Image Section -->
  <figure style="text-align: center; flex: 1;">
    <img src="images/amwo1.jpg" style="width: 100%; max-width: 300px;">
    <figcaption style="font-size: 14px; color: #555;">
      American Woodcock (*Scolopax minor*) at Central Park, Oct 2024, &copy; Xiaoni Xu.
    </figcaption>
  </figure>

</div>

As elusive as they might be, the American Woodcock (*Scolopax minor*) is famous for its unorthodox appearance, its captivating courtship flights at sunset, and its dance move on the internet.
...
<div style="text-align: center;">
  <iframe 
    src="https://ebird.org/map/amewoo?neg=true&env.minX=-74.96461006040708&env.minY=40.487117006902665&env.maxX=-73.20679756040708&env.maxY=41.17705033313023&zh=true&gp=true&ev=Z&excludeExX=false&excludeExAll=false&mr=1-12&bmo=1&emo=12&yr=cur"
    width="800" 
    height="600" 
    style="border: none;">
  </iframe>
