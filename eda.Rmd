...
American woodcocks does not stay the same throughout the year—they migrate, breed, and adapt to their environment depending on the season. Let’s take a closer look at when American Woodcocks make their appearance in New York State. 
...
Spring stands out with the highest observation count, likely due to their courtship behavior during this season, making them easier to detect. In contrast, observations drop significantly in winter, summer, and fall. 
...
American Woodcocks have their own rhythm throughout the day, with their activity levels rising and falling depending on the time. Let’s explore how their activity changes across the day in New York State. 
...
The plot and table together reveal clear patterns in the observation counts of American Woodcocks across different times of the day in New York State. Observations are highest in the evening, followed by the morning. This pattern may be linked to their courtship behavior, as they often produce distinctive sounds during the evening, making it easier for observers to locate and identify them during this time.
...
American Woodcocks are found across New York State, but their activity levels vary by location. Habitat, environment, and observer efforts all play a role in where they are most commonly seen. Let’s look at the plot below to see how they are distributed across the state by county.
...
Tompkins County stands out with the highest number of observations, followed by several other counties with moderate counts. Most counties have relatively low observation numbers, indicating that woodcock activity or observation efforts may be concentrated in specific areas. 
...
The chance of spotting an American Woodcock depends a lot on how the observer behaves. Things like how long they spend looking, how far they travel, the time of day, and the methods they use all make a difference. For example, observers who stay longer in areas where woodcocks live or travel further might have a better chance of seeing one. 

<br>

- <span style="font-size:18px;">**Time of day at which an observation was started**</span>

```{r, warning=FALSE, fig.height=2, fig.width=8}
