...
1. Request for raw data permission from eBird, read and understand the raw data; 2. Changing the raw data type (i.e., original data document is .txt), raw data cleaning and processing; 3. Spatial data manipulation & Environmental data integration; 4. Times- Series analysis; 5. Define proper visualization methods; 6. Git-hub R package for interactive dynamic migration & distribution map; 7. Temporal distribution & Spatial distribution & Migratory patterns analysis

### 7. The planned timeline:
1. Get the data by **11.8**; 2. Formalize detailed ideas and topic by **11.11**; 3. Data screening + cleaning + filtering by **11.15**; 4. Data analysis + Data visualization by **11.22**; 5. Webpage development by **12.7**; 6. Presentation (2 min video) by **12.7**.